...
export default function GetStartedButton({
  ...
  return (
    <Link href={url} className="min-h-12 w-48">
      <button
        className={cn(
          'group flex h-12 w-40 items-center justify-center gap-3 rounded-lg bg-white p-2 font-bold transition-colors duration-100 ease-in-out hover:bg-[#013162]',
          className
        )}
      >
        <span
        ...
        <div
          className={cn(
            ...
            'bg-[#013162] group-hover:bg-blue-200/40'
          )}
        >
